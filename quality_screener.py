...
1. Croissance CA 5 ans (>7% / 3-7% / <3%)
1. Payout ratio (30-60% / 0-30% ou 60-80% / >80%)
1. PER (<18 ou <40 si qualité / 18-25 / >40)
1. ROE (>20% / 10-20% / <10%)
1. Dette nette / EBITDA (<0 ou ≤2 / 2-4 / >4)
1. ROIC moyen 5 ans (>15% / 10-15% / <10%)
1. FCF / Résultat net (≥80% / 50-80% / <50%)
...
# Nettoyage : remplacer les valeurs NaN et Infinity (invalides en JSON standard)
# par 'null' pour garantir que le JSON soit parsable côté navigateur.
